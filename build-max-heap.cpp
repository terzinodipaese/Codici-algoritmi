...
private:
	...
	void heapify(int i)				//conserva la proprietà dell'heap, in questo caso del max-heap
	{
		int l = left(i);
		int r = right(i);
		int massimo = i;
		...
		if(massimo != i)		//se massimo coincidesse con i, allora l'albero a cui stiamo applicando l'heapify sarebbe già un max-heap, quindi 
